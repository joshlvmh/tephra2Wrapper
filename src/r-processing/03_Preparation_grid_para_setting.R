...
# read csv
setwd("~")
tab_input <- read.csv("volcano_set_wind.csv")
tab_input
head(tab_input)
class(tab_input)
...
for(i in 1:nrow(tab_input)){
  ...
  ###setwd("C:/Users/zs20225/OneDrive - University of Bristol/Documents/4D-REEF PhD Uni Bristol/Research/TephraProb modelling/Data/check")
...
# write out csv
setwd("~")
write.csv(tab_output, "volcano_set_grids.csv")
